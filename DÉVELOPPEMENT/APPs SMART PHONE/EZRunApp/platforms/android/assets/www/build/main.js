...
var HelloIonicPage = (function () {
    function HelloIonicPage(navCtrl, geolocation) {
        this.navCtrl = navCtrl;
        this.geolocation = geolocation;
        this._button_text = "START";
        this._time_text = "RUN YO FATASS";
    } //constructor
    HelloIonicPage.prototype.ToggleTimer = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (pos) {
            _this._geo = 'lat: ' + pos.coords.latitude + ', lon: ' + pos.coords.longitude;
        ...
        if (this._button_text == "START") {
            ...
            console.log("this._start_date = " + this._start_date);
        }
        else if (this._button_text == "STOP") {
            this._end_date = new Date();
            console.log("this._end_date = " + this._end_date);
            this._button_text = "START";
            console.log("Minutes of _start_date = " + this._start_date.getUTCMinutes());
            console.log("Minutes of _end_date = " + this._end_date.getUTCMinutes());
            console.log("Total minutes start = " + (this._start_date.getTime() / 1000) / 60);
            console.log("Total minutes end = " + (this._end_date.getTime() / 1000) / 60);
            this._final_time = Math.floor(Number((this._end_date.getTime() / 1000) / 60 - (this._start_date.getTime() / 1000) / 60));
            console.log(this._final_time);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Users\Rémy Kaloustian\Desktop\WORK\MOBILE\EZRun\EZRunApp\src\app\app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Pages</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"C:\Users\Rémy Kaloustian\Desktop\WORK\MOBILE\EZRun\EZRunApp\src\app\app.html"*/
    }),
